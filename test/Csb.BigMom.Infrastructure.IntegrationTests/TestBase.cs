...
#pragma warning restore CA2012 // Use ValueTasks correctly
        ...
        protected BigMomContext CreateContext()
        {
            var contextOptions = new DbContextOptionsBuilder<BigMomContext>().UseNpgsql(Configuration.GetConnectionString("BigMomContext")).Options;
            var context = new BigMomContext(contextOptions);
