...
namespace Csb.BigMom.Infrastructure
{
    ...
    public static class KafkaServiceCollectionExtensions
    {
            ...
            where TMessage : class, new()
        {
            ...
            services.PostConfigure<KafkaProducerOptions<TMessage>>(options => options.ValueSerializerOptions ??= new()
            {
        ...
        {
            services.Configure(configureOptions);
            services.PostConfigure<KafkaConsumerOptions<TMessage>>(options => options.ValueSerializerOptions ??= new()
            {
                PropertyNameCaseInsensitive = true
            });
            services.AddSingleton(p =>
